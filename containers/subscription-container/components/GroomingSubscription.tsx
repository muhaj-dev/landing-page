import {
  GroomingSubscriptionPlansData,
  GroomingSubscriptionPlansDataType,
} from "@/constants";
  ...
  return (
    <div className="sub_cards">
      {GroomingSubscriptionPlansData.map(
        (plan: GroomingSubscriptionPlansDataType, index) => (
          <div className="sub_card" key={index}>
            <div className="sub_ITA">
              <div className="sub_image groomimg_sub_image">
                <img
                  src={plan.subImg}
                  alt="sub image"
                  className="sub_img groomimg_sub_img"
                />
              </div>
