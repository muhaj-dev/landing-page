...
import { DisplayGroceries } from "./containers/detailed-groceries-container/display-groceries/DisplayGroceries";
...
const GroceriesDetail: React.FC<IFoodDetailProps> = ({ id }) => {
