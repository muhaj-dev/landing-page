...
import { OrderedServicesData2, OrderedServicesDataType } from "@/constants/index";
export const OrderedServices2 = () => {
  return (
    <div className="user_cards_container">
      {OrderedServicesData2.map((orderedService: OrderedServicesDataType) => {
