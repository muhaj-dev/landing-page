...
import { OrderedServicesData5, OrderedServicesDataType } from "@/constants/index";

export const OrderedServices5 = () => {
  return (
    <div className="user_cards_container">
      {OrderedServicesData5.map((orderedService: OrderedServicesDataType) => {
